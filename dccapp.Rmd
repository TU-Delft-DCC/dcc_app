...
highchart() %>%
  ...
  hc_add_series(
    ...
    data = list(
      ...
      list(
        name = " ",
        sets = list("ai", "workflow"), 
        value = x[!is.na(ai) & !is.na(workflow), .N],
        color = gray_pal[2]
        ),
      list(
        name = " ",
        sets = list("ai", "data"), 
        value = x[!is.na(ai) & !is.na(data), .N],
        color = gray_pal[2]
        ),
      list(
        name = " ",
        sets = list("ai", "software"), 
        value = x[!is.na(ai) & !is.na(software), .N],
        color = gray_pal[2]
        ),
       list(
        name = " ",
        sets = list("ai", "data", "workflow"), 
        value = x[!is.na(ai) & !is.na(data) & !is.na(workflow), .N],
        color = gray_pal[2]
        ), 
      list(
        name = " ",
        sets = list("ai", "data", "software"), 
        value = x[!is.na(ai) & !is.na(data) & !is.na(software), .N],
        color = gray_pal[2]
        ), 
      list(
        name = " ",
        sets = list("ai", "software", "workflow"), 
        value = x[!is.na(ai) & !is.na(software) & !is.na(workflow), .N],
        color = gray_pal[2]
        ), 
      list(
        name = " ",
        sets = list("ai", "software", "workflow", "data"), 
        value = x[!is.na(ai) & !is.na(software) & !is.na(workflow) & !is.na(data), .N],
        color = gray_pal[4]
        ), 
      list(
        name = " ",
